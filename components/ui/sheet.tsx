...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed z-50 h-full w-full max-w-md bg-background border-border shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-200 data-[state=open]:duration-300",
        side === "right" &&
...
export const SheetHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-1 border-b border-border p-4",
      className,
    )}
    {...props}
  />
